...
var caracteristicas = [{
    ...
    texto: "prorcionar funciones que satisfacen las necesidades declaradas e implícitas, cuando el producto se usa en las condiciones especificadas"
}, {
...
function templateSubCaracteristica(nombre, identificador, colorFondo, zindex, identificadorPadre, ) {
    let template = `<div class="card carta hoverable subCaracteristica dragable"  data-identificador=${identificadorPadre} style="background:${colorFondo};z-index:${zindex}">
<div class="front">
<h4> ${nombre}</h4> 
</div>
...
function templateCaracteristica(nombre, identificador, colorFondo, identificadorPadre) {
    ...
    let template = ` 
    <lu class=" col  collapsible "   >
    <li class="floatleft s12 m8 carta caracteristica "  data-identificador=${identificadorPadre}>
